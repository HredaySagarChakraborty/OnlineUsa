...
public class MyAdapter11 extends RecyclerView.Adapter<MyAdapter11.MyViewHolder> {
    ...
    public MyAdapter11(Context context, int[] images, String[] country) {
        this.context = context;
        this.images11 = images;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.pharmacysample, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.img.setImageResource(images11[position]);
